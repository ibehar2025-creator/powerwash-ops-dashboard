  ...
  async function submit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      if (kind === "job") {
        ...
        await onCreateJob({ ...job, customerId, price: Number(jobPrice) || 0 });
      }
