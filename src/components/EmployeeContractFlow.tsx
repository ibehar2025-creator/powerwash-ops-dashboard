...
function recurringTerms(frequency: string) {
  ...
  return [
    ...
    "",
    "Customer agrees to provide at least 24 hours' notice for any rescheduling.",
    "",
    "In the event of rain, storms, freezing temperatures, or unsafe working conditions, Company may reschedule and will notify Customer using automated messages.",
    "",
    "Automated Messaging and Appointment Reminders",
    "",
    "By signing this Agreement, Customer authorizes Company to send automated text messages and emails for appointment reminders, schedule updates, invoice notifications, and plan renewal reminders. All communications will be sent through the Company's CRM system.",
    "",
