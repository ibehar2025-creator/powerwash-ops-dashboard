...
function Stat({ label, value, detail, icon: Icon }: { label: string; value: string; detail: string; icon: ElementType }) {
  return (
    <Card className={cx("min-h-[122px]", ["Daily pay", "Past due jobs", "Unpaid invoices", "Total tips"].includes(label) && "mobile-hidden-stat")}>
